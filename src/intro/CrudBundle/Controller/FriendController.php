...
class FriendController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('introCrudBundle:Friend')->findAll();

        return $this->render('introCrudBundle:Friend:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('introCrudBundle:Friend:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('introCrudBundle:Friend')->find($id);
        ...
        return $this->render('introCrudBundle:Friend:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('introCrudBundle:Friend:edit.html.twig', array(
            'entity'      => $entity,
